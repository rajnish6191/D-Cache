...
public class GetDataAction extends HttpServlet {	
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
	             ...
	             System.out.println("111111=="+al1.size());
	             System.out.println("2222==="+al2.size());
	             System.out.println("3333=="+al3.size());
	             System.out.println("44444=="+al4.size());
	             System.out.println("55555==="+al5.size());
		...
		try
		{
			    ...
			    {	    
				    	...
				    	arl4.add(cachebean4);
						 ...
						 x =new RegisterDAO().insertIndexDetails(username,dataFormBean2); 
			   
				if(x>0)
				{
			  
		        path="./ResultDisplay1.jsp";
