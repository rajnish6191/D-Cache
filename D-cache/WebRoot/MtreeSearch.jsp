...
<center><h3><font color="teal"><b><i> M-tree Construction Times(D-Cache Not Used)</b></font></h3></center>
    ...
    <table width="" border="0" align="center" bordercolor="#F4F5F7">
      ...
      <tr bgcolor="#asHblue">
        ...
        <td width="170"><div align="center" class="style8"><b>M-tree Time(seconds)</b></div></td>
         <td width="170"><div align="center" class="style8"><b>search Time</b></div></td>
      </tr>
     
      <c:if test="${not empty list2}">
      <c:forEach var="UserInfo" items="${list2}">
        
         
      <tr bgcolor="#CEC9FA" >
   
            <td bgcolor="#F4F5F7"><div align="center"><span class="style7">${UserInfo.query }</span></div></td>
           <td bgcolor="#F4F5F7"><div align="center"><span class="style7">M-tree_${UserInfo.count }</span></div><br>
           </td>
 ...
 <%
String title;
List<DataFormBean> list=(List<DataFormBean>)request.getAttribute("list2");
